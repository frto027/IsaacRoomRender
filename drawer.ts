...
function initJsonPage(path) {
    ...
    infocard.innerHTML = "<h4>房间布局文件</h4>" +
        ...
        '</div>' +
        "<div style='margin:10px 0 10px 0' id='room-previewcard-buttons'><button id='room-previewcard-displayjson' class='btn btn-primary'>显示原始JSON</button><button id='room-preview-card-load-room' class='btn btn-success' style='margin-left:10px'>预览布局</button><a id='huiji-json' target='_blank' class='btn btn-success' style='margin-left:10px'>灰机JSON编辑器</a></div>"
    ;
